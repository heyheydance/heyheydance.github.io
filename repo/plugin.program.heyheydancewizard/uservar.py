...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR limegreen][B]Heyheydance[/B][/COLOR]Wizard'
BUILDERNAME = 'HeyheydanceWizard'
EXCLUDES = [ADDON_ID, 'repository.heyheydancewizard']
# Text File with build info in it. Please read https://github.com/a4k-openproject/plugin.program.openwizard/wiki/Installing-Builds
BUILDFILE = 'https://pastebin.com/raw/RmVFvE0c'
...
REPOID = 'repository.heyheydancewizard'
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR limegreen][B]Heyheydance[/B][/COLOR]Wizard'
